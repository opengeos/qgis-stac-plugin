"""
Update Checker Dialog for STAC Explorer Plugin
...
GITHUB_REPO = "opengeos/qgis-stac-plugin"
GITHUB_BRANCH = "main"
PLUGIN_PATH = "stac_explorer"
METADATA_URL = (
...
class UpdateDownloadWorker(QThread):
    ...
    def run(self):
        ...
        temp_dir = None
        try:
            temp_dir = tempfile.mkdtemp(prefix="stac_explorer_update_")
            ...
            for root, dirs, files in os.walk(extract_dir):
                if "metadata.txt" in files and "stac_explorer_plugin.py" in files:
            ...
            try:
                ...
                def is_valid_plugin_dir(path):
                    ...
                    ) and os.path.exists(os.path.join(path, "stac_explorer_plugin.py"))
                ...
                if os.path.exists(backup_dir) and is_valid_plugin_dir(backup_dir):
                    ...
                    self.error.emit(
                        ...
                        "cannot restore previous plugin version."
                    )
                raise e
...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("STAC Explorer Plugin Update")
    ...
    def _setup_ui(self):
        ...
        # Header
        header_label = QLabel("STAC Explorer Plugin Update Checker")
        header_font = QFont()
    ...
    def _on_check_finished(self, result):
        ...
        Args:
            result: Dict with 'version', 'changelog', and 'metadata' keys.
        """
        self.progress_bar.setVisible(False)
    ...
    def download_and_install(self):
        ...
        self.download_worker = UpdateDownloadWorker(self.plugin_dir)
    ...
    def _on_download_finished(self, install_path):
        ...
        Args:
            install_path: Path where the plugin was installed.
        """
        self.progress_bar.setVisible(False)
        self.progress_label.setVisible(False)
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"STAC Explorer plugin has been updated to version "
