#!/bin/bash
# Installation script for STAC Explorer QGIS Plugin
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --name, -n NAME   Plugin folder name (default: stac_explorer)"
...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    echo "Please manually copy the stac_explorer folder to your QGIS plugins directory."
    exit 1
fi

# Get the directory where this script is located
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SOURCE_DIR="${SCRIPT_DIR}/stac_explorer"
